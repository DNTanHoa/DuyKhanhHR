...
namespace DuyKhanhHR.Mobile {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class DuyKhanhHRMobileApplication : MobileApplication {
        ...
        private DuyKhanhHR.Module.Mobile.DuyKhanhHRMobileModule module4;
        ...
        static DuyKhanhHRMobileApplication() {
        ...
        #endregion
        public DuyKhanhHRMobileApplication() {
        ...
        private void DuyKhanhHRMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new DuyKhanhHR.Module.Mobile.DuyKhanhHRMobileModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DuyKhanhHRMobileApplication_DatabaseVersionMismatch);
